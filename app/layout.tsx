...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "The Saint's TechNet — Built by an Engineer. Trusted by Thousands.",
    description:
      "Premium brand-new and foreign-used tech — verified by a Computer Engineer. Warranty on everything.",
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Prevents dark/light theme flash on page load */}
        <script
