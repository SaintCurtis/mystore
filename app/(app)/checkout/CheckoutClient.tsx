                ...
                {negotiated ? (
                  !isSignedIn ? (
                    ...
                    <Button onClick={handleNegotiatedPayment}
                      ...
                      className="w-full h-12 bg-amber-500 text-zinc-950 hover:bg-amber-400 font-bold shadow-lg shadow-amber-500/20 disabled:opacity-50">
                      {isPayingNegotiated
                        ? <><Spinner className="h-4 w-4 text-zinc-950 mr-2" /> Setting up payment…</>
                  ...
                  <Button
                    className="w-full h-12 gap-2 bg-linear-to-r from-orange-500 to-amber-500 text-white font-bold disabled:opacity-50"
