      ...
      <div className="min-h-screen bg-zinc-50 dark:bg-[#0a0a0a] flex items-center justify-center px-4 transition-colors">
        <div className="mx-auto max-w-md w-full text-center space-y-6">
          <div className="flex justify-center">
            <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-brand-100 dark:bg-brand-500/10">
              <CheckCircle2 className="h-10 w-10 text-brand-500 dark:text-brand-400" />
            </div>
          </div>
          <div>
          ...
          <div className="rounded-xl border border-zinc-200 dark:border-[#1a1a1a] bg-white dark:bg-[#111111] p-5 text-left space-y-3">
            ...
            {[
              ...
              <div key={i} className="flex items-start gap-3">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-brand-500/15 text-xs font-bold text-brand-600 dark:text-brand-400">
                  {i + 1}
                </span>
          ...
          <div className="flex flex-col gap-3">
            <Button asChild className="w-full bg-brand-500 text-white font-bold hover:bg-brand-400 h-11">
              <Link href="/orders">
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-[#0a0a0a] flex items-center justify-center px-4 py-12 transition-colors">
      <div className="mx-auto max-w-md w-full space-y-6">
        ...
        <div className="rounded-2xl border border-zinc-200 dark:border-[#1a1a1a] bg-white dark:bg-[#111111] overflow-hidden">
          <div className="border-b border-zinc-100 dark:border-[#1a1a1a] bg-brand-50 dark:bg-brand-500/5 px-5 py-3">
          ...
          <div className="divide-y divide-zinc-100 dark:divide-[#1a1a1a] px-5">
            ...
            {session.amountTotal && (
              <div className="flex justify-between py-3 text-sm">
                ...
                <span className="font-bold text-zinc-900 dark:text-brand-400">{formatPrice(session.amountTotal / 100)}</span>
              </div>
            )}
            <div className="flex justify-between py-3 text-sm">
        ...
        {/* Actions */}
        <div className="flex flex-col gap-3">
          <Button asChild className="w-full h-11 bg-brand-500 text-white font-bold hover:bg-brand-400">
            <Link href="/orders">
