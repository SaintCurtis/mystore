    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-[#0a0a0a] transition-colors">
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-start justify-between gap-4">
          ...
          <Link
            href="/build-my-setup"
            className="hidden sm:flex items-center gap-1.5 rounded-lg border border-brand-500/30 bg-brand-50 dark:bg-brand-500/8 px-3 py-2 text-sm font-semibold text-brand-700 dark:text-brand-400 hover:bg-brand-100 dark:hover:bg-brand-500/15 transition-colors"
          >
          ...
          {orders.map((order: ORDERS_BY_USER_QUERY_RESULT[number]) => {
            ...
            return (
              <Link
                ...
                className="group block rounded-xl border border-zinc-200 dark:border-[#1a1a1a] bg-white dark:bg-[#111111] transition-all hover:border-zinc-300 dark:hover:border-brand-500/20 hover:shadow-lg dark:hover:shadow-[0_4px_20px_rgba(0,0,0,0.5)]"
              >
                <div className="flex gap-4 p-5">
                  ...
                  <div className="flex min-w-0 flex-1 flex-col justify-between">
                    ...
                    <div className="mt-2 flex items-end justify-between">
                      ...
                      <p className="text-lg font-semibold text-zinc-900 dark:text-brand-400">
                ...
                <div className="flex items-center justify-between border-t border-zinc-100 dark:border-[#1a1a1a] px-5 py-3">
                  ...
                  <span className="flex shrink-0 items-center gap-1 text-sm font-medium text-zinc-500 dark:text-[#a3a3a3] transition-colors group-hover:text-brand-600 dark:group-hover:text-brand-400">
                    View order
