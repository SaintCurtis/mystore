        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            {data.isNegotiatedDeal && (
              <span className="inline-flex items-center gap-1 rounded-full bg-brand-100 dark:bg-brand-900/30 px-2.5 py-1 text-xs font-semibold text-brand-700 dark:text-brand-400">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      {item.product?.slug && (
                        <Link href={`/products/${item.product.slug}`} target="_blank"
                          className="shrink-0 text-zinc-400 hover:text-brand-500 transition-colors">
          ...
          <div className="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="border-t border-zinc-100 dark:border-zinc-800 pt-2 flex justify-between font-bold text-base">
                ...
                <span className="text-zinc-900 dark:text-brand-400">{formatPrice(data.total)}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <div className="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <Link
              ...
              target="_blank"
              className="mt-3 inline-flex items-center gap-1.5 text-sm font-medium text-brand-600 hover:text-brand-500 dark:text-brand-400 dark:hover:text-brand-300 transition-colors"
            >
