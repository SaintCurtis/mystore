...
import { ArrowRight, ShieldCheck, RotateCcw, Globe, Wand2, Sparkles } from "lucide-react";
      ...
      <div className="relative mx-auto max-w-7xl px-4 pt-10 pb-0 sm:px-6 sm:pt-16 lg:px-8 lg:pt-20">
        <div className="flex flex-col lg:flex-row lg:items-end lg:gap-20">
          ...
          <div className="flex-1 pb-10 lg:pb-16">
            ...
            {/* Headline */}
            <h1 className={`font-display font-extrabold leading-[1.05] tracking-tight text-zinc-900 dark:text-[#f1f1f1]
              text-[2.2rem] sm:text-5xl lg:text-6xl xl:text-7xl
              transition-all duration-700 delay-100
              ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
              Premium{" "}
              <span className="relative inline-block">
                <span className={`text-amber-500 dark:text-amber-400 transition-all duration-350 ${visible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-3"}`}
            ...
            <div className={`mt-7 space-y-3 transition-all duration-700 delay-400 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
              ...
              {/* Row 2 — Build My Setup card */}
              <Link href="/build-my-setup"
                className="group flex items-center gap-4 rounded-2xl border border-amber-200 dark:border-amber-500/20 bg-linear-to-r from-amber-50 to-orange-50 dark:from-amber-500/8 dark:to-orange-500/5 px-5 py-4 transition-all duration-200 hover:border-amber-400 dark:hover:border-amber-500/40 hover:shadow-md hover:shadow-amber-500/10 w-full sm:w-auto sm:max-w-sm">
                {/* Icon */}
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-amber-500/15 dark:bg-amber-500/10 group-hover:bg-amber-500/25 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-zinc-500 dark:text-[#a3a3a3] mt-0.5">
                    Tell our AI your budget & needs — get a perfect tailored setup
                  </p>
                </div>
