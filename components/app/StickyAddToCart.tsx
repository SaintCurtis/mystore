...
export function StickyAddToCart({
  ...
  return (
    ...
    >
      <div className="mx-3 mb-2 overflow-hidden rounded-2xl border border-brand-500/30 bg-white/95 dark:bg-[#111111]/95 backdrop-blur-md shadow-2xl shadow-black/20">
