    ...
    <header className="sticky top-0 z-50 border-b border-zinc-200 dark:border-[#1f1f1f] bg-white/95 dark:bg-[#0a0a0a]/95 backdrop-blur-md transition-colors duration-300">
      <div className="mx-auto flex h-14 max-w-7xl items-center px-3 sm:px-6 lg:px-8 gap-2">
        ...
        <Link href="/" className="flex items-center gap-2 group shrink-0">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand-500 shadow-sm shadow-brand-500/20 transition-all group-hover:bg-brand-400 shrink-0">
          ...
          <div className="hidden sm:flex flex-col leading-none">
            ...
            <span className="text-[10px] font-medium text-brand-500 tracking-wider uppercase">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <Button asChild variant="ghost" size="sm"
            className="hidden lg:flex items-center gap-1.5 text-zinc-600 hover:text-brand-600 hover:bg-brand-50 dark:text-[#a3a3a3] dark:hover:text-brand-400 dark:hover:bg-brand-500/8 transition-colors">
          ...
          {!isChatOpen && (
            <Button onClick={openChat} size="sm"
              className="gap-1.5 bg-linear-to-r from-brand-500 to-brand-500 text-white font-semibold shadow-sm hover:from-brand-400 hover:to-brand-400 transition-all duration-200 h-8 px-3">
