                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <Link
                        ...
                        onClick={handleClose}
                        className="text-sm font-semibold text-zinc-900 dark:text-zinc-100 line-clamp-1 hover:text-brand-600 dark:hover:text-brand-400 transition-colors"
                      >
                        {product.name}
                      </Link>
                      ...
                      <p className="text-sm font-bold text-brand-500 dark:text-brand-400 mt-1">
                    ...
                    <button
                      ...
                      className={`flex shrink-0 h-9 w-9 items-center justify-center rounded-xl transition-all duration-200 active:scale-95 ${
                        isAdded
                          ...
                          : "bg-brand-500 text-white hover:bg-brand-400 shadow-md shadow-brand-500/25"
                      }`}
                    >
                      {isAdded ? (
