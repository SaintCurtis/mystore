          ...
          <div>
            ...
            <div className="mt-10 grid grid-cols-3 gap-6 border-t border-zinc-300 dark:border-[#1f1f1f] pt-10">
              {[
                ...
                <div key={label}>
                  <p className="text-3xl font-extrabold text-amber-600 dark:text-amber-400">{value}</p>
            ...
            <div className="space-y-10">
              {MILESTONES.map(({ icon: Icon, year, title, desc }) => (
                <div key={year} className="relative flex gap-6 pl-14">
                  <div className="absolute left-0 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-amber-500/30 bg-amber-500/8 dark:bg-amber-500/6">
                    <Icon className="h-4 w-4 text-amber-600 dark:text-amber-400" />
                  </div>
                  <div>
                    <span className="mb-1 inline-block rounded-full bg-zinc-200 dark:bg-[#1a1a1a] px-3 py-0.5 text-xs font-semibold text-amber-600 dark:text-amber-400">
                      {year}
                    </span>
