        ...
        >
          ...
          <Link
            ...
            className={`flex flex-col items-center justify-center gap-0.5 py-2.5 transition-colors ${
              isHome
                ...
                : "text-zinc-500 dark:text-[#a3a3a3] active:text-brand-500"
            }`}
          >
          ...
          {!isChatOpen ? (
            <button
              ...
              aria-label="Ask AI"
            >
              <div className="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-linear-to-br from-brand-500 to-brand-500 shadow-lg shadow-brand-500/40 ring-2 ring-white dark:ring-[#0a0a0a]">
                <Sparkles className="h-[22px] w-[22px] text-white" />
              </div>
              <span className="text-[10px] font-bold text-brand-500 dark:text-brand-400">Ask AI</span>
            </button>
          ) : (
          ...
          <button
            type="button"
            onClick={openCart}
            className="relative flex flex-col items-center justify-center gap-0.5 py-2.5 text-zinc-500 dark:text-[#a3a3a3] transition-colors active:text-brand-500"
            aria-label="Cart"
          >
            <ShoppingBag className="h-5 w-5" strokeWidth={1.8} />
            {totalItems > 0 && (
              <span className="absolute top-1.5 right-3 flex h-4 w-4 items-center justify-center rounded-full bg-brand-500 text-[9px] font-bold text-white">
