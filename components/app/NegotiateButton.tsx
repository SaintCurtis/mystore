            ...
            {isMinimised ? (
              ...
              >
                <div className="w-7 h-7 rounded-full bg-amber-500 flex items-center justify-center shrink-0">
                  <ChatBubbleLeftRightIcon className="w-3.5 h-3.5 text-zinc-950" />
                </div>
                ...
                <div className="w-2 h-2 rounded-full bg-amber-500 animate-pulse ml-1 shrink-0" />
              </button>
            ) : (
              /* Full chat widget */
              <div
