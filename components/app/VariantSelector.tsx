          ...
          return (
            <div key={group.type} className="flex flex-col gap-2.5">
              ...
              >
                ...
                {isOn && (
                  <span className="ml-auto flex h-5 w-5 items-center justify-center rounded-full bg-brand-500">
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isSelected
                          ? "ring-2 ring-brand-500 ring-offset-2 ring-offset-white dark:ring-offset-[#0a0a0a] scale-110 shadow-md shadow-brand-500/20"
              ...
              {group.options.map((opt) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && (
                      <span className="absolute -top-1.5 -right-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-brand-500 shadow-sm">
