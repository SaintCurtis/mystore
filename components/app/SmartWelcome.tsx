...
export function SmartWelcome({ allCategorySlugs = [] }: SmartWelcomeProps) {
  ...
  return (
    <div className="relative mx-auto max-w-7xl px-3 sm:px-6 lg:px-8 pt-4">
      <div className="rounded-2xl border border-brand-200 dark:border-brand-800/50 bg-brand-50 dark:bg-brand-950/20 p-4 sm:p-5">
        {/* Header */}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {products.map((product) => (
            <Link
              ...
              className="group rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden hover:border-brand-400 dark:hover:border-brand-600 transition-all duration-200 hover:shadow-md hover:shadow-brand-500/10"
            >
        ...
        <div className="mt-3 flex justify-end">
          <Link
            href="/"
            className="inline-flex items-center gap-1 text-xs text-brand-600 dark:text-brand-400 hover:underline underline-offset-2 font-medium"
          >
            Browse all products
