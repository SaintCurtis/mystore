      ...
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8 space-y-6">
            ...
            {referralUrl ? (
              <>
                ...
                <div className="flex items-center gap-2 mb-5">
                  ...
                  <span className="rounded-lg bg-brand-500/10 border border-brand-500/20 px-3 py-1 text-sm font-black tracking-widest text-brand-600 dark:text-brand-400">
                    {referral?.code}
                  </span>
                </div>
        ...
        {activeTab === "overview" && (
          <div className="space-y-4">
                  ...
                  <div key={step} className="flex gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-0.5">
                        <span className="text-[10px] font-black tracking-widest text-brand-500/60">STEP {step}</span>
                      </div>
            ...
            <div className="rounded-2xl border border-brand-200 dark:border-brand-900/40 bg-brand-50 dark:bg-brand-900/10 p-5">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={tip} className="flex items-start gap-2 text-xs text-brand-800 dark:text-brand-300">
                    <ChevronRight className="h-3 w-3 mt-0.5 shrink-0 text-brand-500" />
                    {tip}
                  </li>
                ))}
              </ul>
                  ...
                  return (
                    <div key={entry._id}
                      className={cn(
                        ...
                        isCurrentUser && "bg-brand-50 dark:bg-brand-900/10",
                      )}>
