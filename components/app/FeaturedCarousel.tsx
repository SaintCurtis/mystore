  ...
  return (
    <div className="flex min-h-[400px] flex-col md:min-h-[450px] md:flex-row lg:min-h-[500px]">
      ...
      <div className="flex w-full flex-col justify-center px-6 py-8 md:w-2/5 md:px-10 lg:px-16">
        {product.category && (
          <Badge variant="secondary" className="mb-4 w-fit bg-brand-500/20 text-brand-400 hover:bg-brand-500/30">
        ...
        {/* ✅ formatInCurrency instead of formatPrice — respects ₦/$ toggle */}
