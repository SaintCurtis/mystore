        ...
        <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
          {items.map((item) => (
            <Link key={item.productId} href={`/products/${item.slug}`}
              className="group shrink-0 w-44 flex flex-col overflow-hidden rounded-xl border border-zinc-200 dark:border-[#1f1f1f] bg-white dark:bg-[#111111] transition-all duration-200 hover:-translate-y-0.5 hover:border-zinc-300 dark:hover:border-blue-500/20 hover:shadow-lg dark:hover:shadow-[0_4px_20px_rgba(0,0,0,0.6)]">
              ...
              <div className="flex flex-col gap-1 p-3">
                ...
                <p className="mt-1 text-sm font-bold text-zinc-900 dark:text-blue-400">
