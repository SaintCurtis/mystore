    ...
    <button
      ...
      className={cn(
        ...
        isCompared
          ...
          : "bg-zinc-100 dark:bg-[#1a1a1a] text-zinc-500 dark:text-[#a3a3a3] border border-zinc-200 dark:border-[#2a2a2a] hover:border-brand-500/40 hover:text-brand-600 dark:hover:text-brand-400",
